...
def download_image(url, folder_path, file_name, callback):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            file_path = folder_path  + "/" + 'image_' + file_name + ".jpg"
...
def Download():
    ...
    if index == len(ImageUrls):
        ...
        download_image(content,directory,name,downloadCallback)
